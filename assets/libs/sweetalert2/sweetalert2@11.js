...
(!(function (e, t) {
  ...
  function nn(e) {
    ...
    const i = on(e),
      s = Object.assign({}, o, i);
    (tn(s), t && (t.dataset.swal2Theme = s.theme), Fe(this, s), he.innerParams.set(this, s), Object.defineProperties(this, { params: { value: Object.assign({}, this.params, e), writable: !1, enumerable: !0 } }));
  }
  const on = (e) => {
    const t = {};
    return (
  ...
  const kn = ['swal-title', 'swal-html', 'swal-footer'],
    ...
    xn = (e) => {
      const t = {},
        n = e.querySelector('swal-success-icon');
    ...
    On = (e) => {
      const t = kn.concat(['swal-param', 'swal-function-param', 'swal-button', 'swal-image', 'swal-success-icon', 'swal-input', 'swal-input-option']);
    ...
    Hn = (e) => {
      ...
      const n = y();
      n && (t.removeEventListener('animationend', Hn), t.removeEventListener('transitionend', Hn), (n.style.overflowY = 'auto'), W(n, r['no-transition']));
    },
    In = (e, t) => {
